# Лабораторная работа №4 — Интерактивная модель государства

 Реализует веб-приложение, моделирующее состояние государства: население, экономику, инфраструктуру и органы власти. Проект находится в `sem2/lab4`. Точка входа — `sem2/lab1/Utilities/app.py`.
